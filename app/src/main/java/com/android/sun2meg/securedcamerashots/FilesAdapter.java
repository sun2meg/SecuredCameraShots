...
import static com.android.sun2meg.securedcamerashots.MainActivity.mDriveServiceHelper;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.downloadFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mDriveServiceHelper.downloadFile(new File(STORAGE_FOLDER_PATH, fileInfo.getName()), fileInfo.getId())
